...
const variantClasses: Record<BadgeVariant, string> = {
  ...
  neutral: "bg-ds-elevated text-ds-secondary",
  ...
  danger: "bg-error-50 text-error-700 dark:bg-error-500/15 dark:text-error-200",
  info: "bg-info-50 text-info-700 dark:bg-info-500/15 dark:text-info-200",
};

const Badge: React.FC<BadgeProps> = ({ variant = "default", icon, children, className = "" }) => {
  return (
    <span
