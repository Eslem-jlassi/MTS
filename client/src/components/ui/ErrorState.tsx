...
const ErrorState: React.FC<ErrorStateProps> = ({
  ...
  return (
    ...
    >
      <div className="mb-4 flex h-14 w-14 items-center justify-center rounded-2xl border border-error-200/80 bg-error-50/95 text-error-600 shadow-sm dark:border-error-500/20 dark:bg-error-500/12 dark:text-error-300">
